...
import com.example.dell.menu.menuplanning.events.meals.AddProductToIngredientsEvent;
import com.example.dell.menu.menuplanning.events.meals.DeleteProductFromMealEvent;
import com.example.dell.menu.menuplanning.events.meals.ProductAddedSuccessfullyToIngredientsEvent;
...
import com.example.dell.menu.data.tables.MealsTypesMealsTable;
...
public class AddOrEditMealManager {
    ...
    private class DownloadProductsInMeal extends AsyncTask<Integer, Integer, List<Product>>{
        ...
        protected List<Product> doInBackground(Integer... params) {
            ...
            String query = String.format("SELECT %s, %s, %s, %s, %s, %s, %s, %s FROM %s p JOIN %s mp\n" +
                            "ON mp.%s = p.%s WHERE mp.%s = '%s';",
                    ProductsTable.getFirstColumnName(),
                    ProductsTable.getSecondColumnName(),
                    ProductsTable.getThirdColumnName(),
                    ProductsTable.getFifthColumnName(),
                    ProductsTable.getSixthColumnName(),
                    ProductsTable.getSeventhColumnName(),
                    ProductsTable.getEighthColumnName(),
